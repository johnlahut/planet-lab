...
for root, dirs, files in os.walk(root_dir, onerror=None):  # walk the root dir
    for filename in files:  # iterate over the files in the current dir
        ...
        try:
            ...
            pass
print("The number of files 3-5 with * ", count)

root_dir_2 = "/Users/bharghavbaddam/PycharmProjects/CCN_Project/Traceroute_5-3"  # path to the root directory to search
count_2 = 0
dict2 = {}
dict4 = {}
generalCount2 = 0
for root, dirs, files in os.walk(root_dir_2, onerror=None):  # walk the root dir
    for filename2 in files:  # iterate over the files in the current dir
        ...
        try:
            ...
            pass
print("The number of files 5-3 with * ", count_2)
...
print("Fraction in 3-5 and 5-3 in ",fraction)
