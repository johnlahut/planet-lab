...
edgePercent1to5 = (edgeCount/totalLineCount)*100
corePercent1to5 = (coreCount/totalLineCount)*100

edgePercent5to1 = (edgeCount2/totalLineCount2)*100
corePercent5to1 = (coreCount2/totalLineCount2)*100

print("Long Term Outage 1 to 5", longCount)
print("Long Term Outage 5 to 1", longCount2)

print("Outage Count 1 to 5",outageCount)
print("Outage Count 5 to 1",outageCount2)

print("Edge Percentage 1 to 5 ", edgePercent1to5)
print("Core Percentage 1 to 5", corePercent1to5)

print("Edge Percentage 5 to 1 ", edgePercent5to1)
print("Core Percentage 5 to 1", corePercent5to1)

print("Long Term Outage New Calculation on 1 to 5 ",longOutNew)
print("Long Term Outage New Calculation on 5 to 1 ",longOutNew2)
