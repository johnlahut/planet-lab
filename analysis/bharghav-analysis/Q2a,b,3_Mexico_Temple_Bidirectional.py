...
root_dir = "/Users/bharghavbaddam/PycharmProjects/CCN_Project/Traceroute_4-7"  # path to the root directory to search
dict1 = {}
dict3 = {}
outageCount = 0
list1 = ['129.32' , '148.206']
edgeCount = 0
coreCount = 0
totalLineCount = 0
longOutNew = 0
for root, dirs, files in os.walk(root_dir, onerror=None):  # walk the root dir
    for filename in files:  # iterate over the files in the current dir
        ...
        try:
            ...
            pass
root_dir = "/Users/bharghavbaddam/PycharmProjects/CCN_Project/Traceroute_7-4"  # path to the root directory to search
dict1 = {}
dict3 = {}
outageCount2 = 0
list1 = ['129.32' , '148.206']
...
edgePercent4to7 = (edgeCount/totalLineCount)*100
corePercent4to7 = (coreCount/totalLineCount)*100

edgePercent7to4 = (edgeCount2/totalLineCount2)*100
corePercent7to4 = (coreCount2/totalLineCount2)*100


print("Long Term Outage 4 to 7", longCount)
print("Long Term Outage 7 to 4", longCount2)


print("Outage Count 4 to 7",outageCount)
print("Outage Count 7 to 4",outageCount2)

print("Edge Percentage 4 to 7 ", edgePercent4to7)
print("Core Percentage 4 to 7", corePercent4to7)

print("Edge Percentage 7 to 4 ", edgePercent7to4)
print("Core Percentage 7 to 4", corePercent7to4)

print("Long Term Outage New Calculation on 4 to 7 ",longOutNew)
print("Long Term Outage New Calculation on 7 to 4 ",longOutNew2)