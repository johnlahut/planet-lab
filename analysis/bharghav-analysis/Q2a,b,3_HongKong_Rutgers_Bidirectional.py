...
for root, dirs, files in os.walk(root_dir, onerror=None):  # walk the root dir
    for filename in files:  # iterate over the files in the current dir
        ...
        try:
            ...
            pass
root_dir = "/Users/bharghavbaddam/PycharmProjects/CCN_Project/Traceroute_8-6"  # path to the root directory to search
dict1 = {}
dict3 = {}
outageCount2 = 0
list1 = ['165.230' , '103.49']
...
edgePercent6to8 = (edgeCount/totalLineCount)*100
corePercent6to8 = (coreCount/totalLineCount)*100

edgePercent8to6 = (edgeCount2/totalLineCount2)*100
corePercent8to6 = (coreCount2/totalLineCount2)*100

print("Long Term Outage 6 to 8", longCount)
print("Long Term Outage 8 to 6", longCount2)


print("Outage Count 6 to 8",outageCount)
print("Outage Count 8 to 6",outageCount2)

print("Edge Percentage 6 to 8 ", edgePercent6to8)
print("Core Percentage 6 to 8", corePercent6to8)

print("Edge Percentage 8 to 6 ", edgePercent8to6)
print("Core Percentage 8 to 6", corePercent8to6)

print("Long Term Outage New Calculation on 6 to 8 ",longOutNew)
print("Long Term Outage New Calculation on 8 to 6 ",longOutNew2)
